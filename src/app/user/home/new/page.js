  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 min-h-screen text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>

      {/* Floating Navigation */}
      <nav className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 ${scrollY > 50 ? 'bg-black/20 backdrop-blur-xl border border-white/20 rounded-2xl px-8 py-3' : 'bg-transparent px-4 py-2'}`}>
        <div className="flex items-center space-x-8">
          <div className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            ShopEase
          </div>
          <div className="hidden md:flex space-x-6">
            <a href="#" className="hover:text-purple-400 transition-all duration-300 hover:scale-110">Home</a>
            <a href="#" className="hover:text-purple-400 transition-all duration-300 hover:scale-110">Collections</a>
            <a href="#" className="hover:text-purple-400 transition-all duration-300 hover:scale-110">Blog</a>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href='/user/product' className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105 text-center">
            ...
            <div className="flex gap-8 pt-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">99%</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-20 animate-pulse"></div>
            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full opacity-20 animate-pulse" style={{animationDelay: '1s'}}></div>
          </div>
        </div>
      </section>
          ...
          {!collections ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {collections.map((c, index) => (
                <div 
                  key={c.id} 
                  className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-500 hover:transform hover:scale-105"
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="relative mb-6">
                      <img 
                        src={c.cover_image} 
                        alt={c.name} 
                        className="w-32 h-32 rounded-full object-cover border-4 border-white/20 group-hover:border-purple-400/50 transition-all duration-500 group-hover:scale-110" 
                      />
                    ...
                    <Link href={`/user/collection/${c.id}`}>
                      <h3 className="font-bold text-xl text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text transition-all duration-300">
                        {c.name}
                      </h3>
                    </Link>
                    
                    <div className="mt-4 px-6 py-2 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full border border-white/20 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
        ...
        <div className={`transition-all duration-1000 ${isVisible.features ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-white/40 transition-all duration-500 hover:transform hover:scale-105"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-xl mb-4 text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text transition-all duration-300">
                    {feature.title}
                  </h3>
      ...
      <section id="blogs" data-animate className="max-w-7xl mx-auto px-8 py-20">
        <div className={`transition-all duration-1000 ${isVisible.blogs ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          <div className="flex items-center justify-between mb-16">
            ...
            <Link 
              href="/user/blog" 
              className="group px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full font-semibold hover:shadow-2xl hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-105"
            >
          ...
          {!blogs ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {blogs.slice(0, 3).map((b, index) => (
                <div
                  key={b.id}
                  className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-500 hover:transform hover:scale-105"
                  style={{animationDelay: `${index * 0.1}s`}}
                >
                  ...
                  <div className="relative p-6">
                    <div className="flex flex-wrap gap-2 mb-3">
                      {Array.isArray(b.tags) && b.tags.slice(0, 3).map((tag, idx) => (
                        <span 
                          key={tag + idx} 
                          className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 text-purple-300 text-xs px-3 py-1 rounded-full font-semibold border border-purple-400/30"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <h3 className="font-bold text-xl text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text transition-all duration-300">
                      {b.topic}
                    </h3>
                    ...
                    <a
                      href={`/user/blog/${b.id}`}
                      className="inline-flex items-center gap-2 text-purple-400 font-semibold text-sm hover:text-pink-400 transition-colors duration-300 group-hover:translate-x-1"
                    >
                      Read More
        ...
        <div className="relative bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-lg rounded-3xl p-16 border border-white/20 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href='/user/product' className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105">
                Explore Products
              </Link>
              <button className="px-8 py-4 border-2 border-white/20 rounded-full font-semibold text-lg hover:bg-white/10 hover:border-white/40 transition-all duration-300 backdrop-blur-sm">
                Contact Us
